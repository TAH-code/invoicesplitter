...
// No I/O, no DOM. Works in Node (require) and the browser (window.Split) so the
// UI can preview shares with the exact same math the server uses.
//
...
(function (root, factory) {
  ...
  if (typeof window !== "undefined") window.Split = api;
